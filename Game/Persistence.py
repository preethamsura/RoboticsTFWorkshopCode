...
def playGUI():
    ...
    startGame = 0               # Change this value to play whatever game you wanted. Our games are 0 indexed. 
    listIndex, index = 0, 0
    game = Snake.Snake()
    game.startGame()
    all_moves = objects[0]
    ...
    # Go through all saved games and play them
    for i in range(startGame, len(all_moves)):
        moves = all_moves[i]
